...
class KeyStoreLoader {
    ...
    KeyStoreLoader load(File baseDir) throws Exception {
        ...
        if (!serverKeyStore.exists()) {
            ...
            String applicationUri = Constants.PUBLIC_URI + ":" + UUID.randomUUID();

            SelfSignedCertificateBuilder builder = new SelfSignedCertificateBuilder(keyPair)
                .setCommonName(Constants.COMMON_NAME)
                .setOrganization(Constants.ORGANIZATION)
                .setOrganizationalUnit(Constants.ORGANIZATION_UNIT)
                .setLocalityName(Constants.LOCALITY_NAME)
                .setStateName(Constants.STATE_NAME)
